...
class Net(nn.Module):
    def __init__(self):
        ...
        self.bn = nn.BatchNorm1d(512) # added
        self.fc2 = nn.Linear(512,512) # added
...
if __name__ == "__main__":
    ...
    # added
    pre_trained_dict = torch.load('mytraining.pth')
    # print(pre_trained_dict)
    ...
    # optimizer = optim.Adagrad(net.parameters(), lr=0.0003, lr_decay=0.0002)
    optimizer = optim.Adagrad(net.parameters(), lr=0.0003, lr_decay=0.0002, weight_decay=0.00003)
